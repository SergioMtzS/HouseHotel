...
export class HomePage implements OnInit {
  ...
  deleteCustomer(customer, i) {
    if (window.confirm('Do you want to delete user? ' + customer.FirstName + ' ' + customer.LastName)) {
  ...
  logicCostumer(customer, i) {
    if (window.confirm('Do you want to logic delete? ' + customer.FirstName + ' ' + customer.LastName)) {
